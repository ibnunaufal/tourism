			...
			<div class="row">
				<aside class="col-lg-3">
					...
					<div class="box_style_cat">
						<ul id="cat_nav">
							<li><a href="#" id="active"><i class="icon_set_1_icon-58"></i>Semua Kuliner <span>(141)</span></a>
							</li>
							
                            <li><a href="#"><i class="icon_set_3_restaurant-5"></i> Tradisional <span>(141)</span></a></li>
                            <li><a href="#"><i class="icon_set_3_restaurant-11"></i> Restaurant <span>(141)</span></a></li>    
						</ul>
					</div>
