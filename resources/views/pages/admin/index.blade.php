    ...
    <div class="home-content">
      <div class="sales-boxes" style="width:100%;">
        <div class="recent-sales box" style="width:100%;">
          <div class="title">Daftar Kategori</div>
          <div class="sales-details">
          <div class="table-responsive">
            <table class="table">
                    <tr class="table-bordered">
                    ...
                    <tr class="table-bordered">
                        ...
                        <td class="td-bordered col-md-4">
                            ...
                            @endforeach
                            <li>
                                <a href="subcategory/create?cat={{$cat->id}}" class="btn btn-primary" style="font-size: 12px;color: white;">
                                    Tambah SubKategori
                                </a>
                            </li>
                        </td>
                        <td class="td-bordered col-md-1" style="text-align: center;">
                            <!-- <form action="{{ route('category.destroy',$cat->id) }}" method="POST"> -->
                                <button>
                                <a class="btn btn-primary" href="{{ route('category.edit',$cat->id) }}"><i class="bx bx-edit"></i></a>
                                </button>
                                <form action="{{route('category.destroy', $cat->id)}}" method="POST">    
                                @method('DELETE')
                                @csrf
                    ...
                    <table class="table">
                        ...
                        <tr class="table-bordered">
                            ...
                            <td class="td-bordered col-md-1" style="text-align: center;">
                                <!-- <form action="{{ route('tempat.destroy',$temp->id) }}" method="POST"> -->
                                    <button>
                                    <a class="btn" href="{{ route('tempat.edit',$temp->id) }}"><i class="bx bx-edit"></i></a>
                                    </button>
                                    <form action="{{route('tempat.destroy', $temp->id)}}" method="POST">    
                                    @method('DELETE')
                                    @csrf
                        ...
                        <tr class="table-bordered">
                            ...
                            <td class="td-bordered col-md-1" style="text-align: center;">
                                <!-- <form action="{{ route('tempat.destroy',$head->id) }}" method="POST"> -->
                                    <button>
                                    <a class="btn" href="{{ route('headline.edit',$head->id) }}"><i class="bx bx-edit"></i></a>
                                    </button>
                        ...
                        <tr class="table-bordered">
                            ...
                            <td class="td-bordered col-md-1" style="text-align: center;">
                                <!-- <form action="{{ route('tempat.destroy',$aca->id) }}" method="POST"> -->
                                    <button>
                                    <a class="btn" href="{{ route('headline.edit',$aca->id) }}"><i class="bx bx-edit"></i></a>
                                    </button>
                                    <form action="{{route('headline.destroy', $aca->id)}}" method="POST">    
                                    @method('DELETE')
                                    @csrf
                                        <button type="submit" class="btn btn-danger" onclick="return myFunction1();">
                                            <i class="bx bx-trash"></i>
